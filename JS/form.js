...
Validator.isRequired = function (selector, mess) {
    return {
        ...
        test: function (value) {
            ...
            return value ? undefined : mess || "Email không được để trống";
        },
    };
};
...
Validator({
    ...
    onsubmit: function (data) {
        ...
        if (data.fullname) {
            ...
            <button><a href="../HTML/index.html" class="muaSam" style="text-decoration: none; color:white">Đăng nhập để mua sắm</a>
            </div>   
      `
        }
    },
